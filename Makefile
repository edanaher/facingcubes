...
layout6prune: layout.c buildlayout.c
	${CC} layout.c -olayout6prune ${OPTFLAGS} -DDIMENSION=6 -DCACHEDEPTH=6 -DKEEPPROGRESS=20 -DDISPLAYDEPTH=5 -DBIRTHDAYHASH=1 -DPRUNEMATCHINGS=5 -DTIMELIMIT=1800 -DTIMELIMITEXPECTED=43200
