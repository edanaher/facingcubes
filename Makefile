...
# - PRUNEMATCHIGNS: Check if a maximal matching is the right size
...
layout6: layout.c buildlayout.c Makefile
	${CC} layout.c -olayout6 ${OPTFLAGS} -DDIMENSION=6 -DCACHEDEPTH=6 -DKEEPPROGRESS=20 -DDISPLAYDEPTH=5 -DBIRTHDAYHASH=1 -DPRUNEMATCHINGS=5
...
layout6prune: layout.c buildlayout.c
	${CC} layout.c -olayout6prune ${OPTFLAGS} -DDIMENSION=6 -DCACHEDEPTH=6 -DKEEPPROGRESS=20 -DDISPLAYDEPTH=5 -DBIRTHDAYHASH=1 -DPRUNEMATCHINGS=5 -DTIMELIMIT=28800 -DTIMELIMITEXPECTED=172800
